...
WHISPER_MODEL = "paraformer-zh"  # "large-v3"
...
# 初始化 funasr 模型
funasr_model = AutoModel(model=WHISPER_MODEL,
                         vad_model="fsmn-vad",
                         vad_kwargs={"max_single_segment_time": RECORD_DURATION_LONG * 1000},
                         punc_model="ct-punc",
                         trust_remote_code=False, device="cuda:0")
